...
vars = [character_traits, cities, consumerism, hobbies, jobs, lifegoals, lifestyles, media, names, pers_attributes, prof_attributes, prof_goals, softskills, surnames, values]
clean(vars)